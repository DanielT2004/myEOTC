          ...
          <div className="relative -mx-4 px-4 sm:mx-0 sm:px-0 overflow-hidden max-w-[100vw] sm:max-w-none">
            ...
            {featuredChurches.length === 0 ? (
              ...
              featuredChurches.map(church => (
                <div key={church.id} className="w-[85vw] max-w-[85vw] sm:w-[360px] sm:min-w-[360px] sm:max-w-[360px] h-[380px] sm:h-[420px] flex-shrink-0 snap-start">
                  <ChurchCard
                    church={church}
          ...
          <div className="relative -mx-4 px-4 sm:mx-0 sm:px-0 overflow-hidden max-w-[100vw] sm:max-w-none">
            ...
            {featuredEvents.length === 0 ? (
              ...
              featuredEvents.map(event => (
                <div key={event.id} className="w-[85vw] max-w-[85vw] sm:w-[360px] sm:min-w-[360px] sm:max-w-[360px] h-[380px] sm:h-[420px] flex-shrink-0 snap-start">
                  <EventCard
                    event={event}
